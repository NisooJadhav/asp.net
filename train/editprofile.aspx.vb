...
Partial Class Default2
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Dim cmd As New SqlCommand("update user_details set city='" + TextBox2.Text + "',state='" + TextBox3.Text + "',mobile='" + TextBox4.Text + "',email='" + TextBox5.Text + "'where username='" + Session("un") + "'", cn)
        Dim chk As Integer
        cn.Open()
